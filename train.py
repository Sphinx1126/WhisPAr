...
def set_args():
    ...
    parser.add_argument("--save_step", type=int, default=24000)
    parser.add_argument("--eval_step", type=int, default=2400)
...
if __name__ == '__main__':
    ...
    model = WhisPAr(cls_num=args.cls_num,prompt_len=args.prompt_len,
